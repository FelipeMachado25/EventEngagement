...
if df_raw is not None:
    ...
    # ── TABS ─────────────────────────────────────────────────────────────────
    tab1, tab2, tab3 = st.tabs(["📊 General Model", "🎯 Specific Model", "🤖 AI Advisory"])
    ...
    with tab2:
        ...
        st.dataframe(display_df.style.background_gradient(cmap='Blues', vmin=1, vmax=7), use_container_width=True)
